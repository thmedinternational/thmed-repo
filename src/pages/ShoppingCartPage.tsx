      ...
      <div className="grid md:grid-cols-3 gap-8">
        ...
        <div className="md:col-span-1 bg-secondary p-6 rounded-lg shadow-md sticky top-20 text-secondary-foreground">
          ...
          <div className="mt-6 space-y-3">
            ...
            <Button className="w-full py-3 text-lg bg-secondary text-secondary-foreground hover:bg-secondary/80" onClick={() => handleWhatsAppAction('quotation')}>
              <FileText className="mr-2 h-5 w-5" /> Request Quotation
            </Button>
            <Button className="w-full py-3 text-lg bg-secondary text-secondary-foreground hover:bg-secondary/80" onClick={() => handleWhatsAppAction('delivery')}>
